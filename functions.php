...
{
	wp_enqueue_style('newman-tactical-aos-yt-player-css', '//cdnjs.cloudflare.com/ajax/libs/jquery.mb.YTPlayer/3.3.3/css/jquery.mb.YTPlayer.min.css', array(), _S_VERSION);
	wp_enqueue_style('newman-tactical-aos', '//cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css', array(), _S_VERSION);
	wp_enqueue_style('newman-tactical-owl-def-theme-css', '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.css', array(), _S_VERSION);
	wp_enqueue_style('newman-tactical-owl-css', '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css', array(), _S_VERSION);
	...
	wp_enqueue_style('newman-tactical-font-body', '//fonts.googleapis.com/css2?family=Questrial&family=Unica+One&display=swap', array(), null);
	...
	wp_enqueue_script( 'orngatuny-mara-king-camp-jquery-js', '//cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js', array(), _S_VERSION, true );
	wp_enqueue_script('newman-tactical-yt-player', '//cdnjs.cloudflare.com/ajax/libs/jquery.mb.YTPlayer/3.3.3/jquery.mb.YTPlayer.min.js', array(), _S_VERSION, true);
	wp_enqueue_script('newman-tactical-bootstrap', '//cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.3/js/bootstrap.min.js', array(), _S_VERSION, true);
	wp_enqueue_script('newman-tactical-owl', '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js', array(), _S_VERSION, true);
	...
	wp_enqueue_script('newman-tactical-js', get_template_directory_uri() . '/js/theme.js', array(), _S_VERSION, true);
	wp_localize_script('newman-tactical-js', 'localized_objects', array(
		'wp-ajax-url'	=>	admin_url('admin-ajax.php')
	));
